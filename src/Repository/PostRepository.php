...
class PostRepository {
    ...
    public function persist(Post $post) {
        ...
        $query = $connection->prepare('INSERT INTO post (message, posted_at, latitude,longitude,author, category_id) VALUES(:message,:postedAt,:latitude,:longitude,:author,:categoryId)');
